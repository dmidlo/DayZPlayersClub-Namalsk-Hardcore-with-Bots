class CraftGenerator extends RecipeBase
{	
	override void Init()
	{   
		m_Name = "craft Generator"; //Название-действие
		...
		InsertIngredient(0,"Spur_Kart_FuelTank");      //Вы можете вставить несколько ингредиентов таким образом
		...
		//РЕЗУЛЬТАТ 
		AddResult("PowerGenerator"); //Добавить результаты здесь
