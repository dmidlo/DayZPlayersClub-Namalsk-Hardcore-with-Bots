class DeconstructSmallVehicles extends RecipeBase
{	
	override void Init()
	{   
		...
		//Ингредиенты #2
		//ИСПОЛЬЗУЕМЫЙ ПРЕДМЕТ
		InsertIngredient(1,"Techs_ATV_OD");
		InsertIngredient(1, "SavageSherpa_Cargo");
		InsertIngredient(1, "SavageSherpa_Black");
		InsertIngredient(1, "SavageSherpa_Blue");
		InsertIngredient(1, "SavageSherpa_Brown");
		InsertIngredient(1, "SavageSherpa_Green");
		InsertIngredient(1, "SavageSherpa_Mint");
		InsertIngredient(1, "SavageSherpa_Pink");
		InsertIngredient(1, "SavageSherpa_Purple");
		InsertIngredient(1, "SavageSherpa_Red");
		InsertIngredient(1, "SavageSherpa_Savage");
		InsertIngredient(1, "SavageSherpa_Yellow");
		InsertIngredient(1, "SavageSherpa_White");
		InsertIngredient(1, "vg7_scorpion");
		...
		AddResult("TannedLeather"); //Добавить результаты здесь
