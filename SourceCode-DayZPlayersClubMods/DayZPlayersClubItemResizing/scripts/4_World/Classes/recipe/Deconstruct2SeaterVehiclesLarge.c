class Deconstruct2SeaterVehiclesLarge extends RecipeBase
{	
	override void Init()
	{   
		...
		//Ингредиенты #2
		//ИСПОЛЬЗУЕМЫЙ ПРЕДМЕТ
		InsertIngredient(1,"Kamaz");
		InsertIngredient(1, "KamazCovered");
		InsertIngredient(1, "RFFSHeli_LittleBird");
		InsertIngredient(1, "RFFSHeli_LittleBird_Camo");
		InsertIngredient(1, "RFFSHeli_R22");
		InsertIngredient(1, "RFFSHeli_R22_Red");
		InsertIngredient(1, "RFFSHeli_R22_Black");
