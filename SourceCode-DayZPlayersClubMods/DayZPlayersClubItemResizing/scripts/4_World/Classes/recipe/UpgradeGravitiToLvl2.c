class UpgradeGravitiToLvl2 extends RecipeBase
{	
	override void Init()
	{   
		...
		InsertIngredient(0,"ONLI_Graviti");      //Вы можете вставить несколько ингредиентов таким образом
		...
		//РЕЗУЛЬТАТ 
		AddResult("ONLI_Graviti2"); //Добавить результаты здесь
