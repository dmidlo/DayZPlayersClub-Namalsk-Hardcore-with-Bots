class DeconstructTrolleySeat extends RecipeBase
{	
	override void Init()
	{   
		m_Name = "Take apart seat"; //Название-действие
		...
		InsertIngredient(0,"Screwdriver");      //Вы можете вставить несколько ингредиентов таким образом
		...
		//Ингредиенты #2
		//ИСПОЛЬЗУЕМЫЙ ПРЕДМЕТ
		InsertIngredient(1,"Spur_Kart_Seat");
