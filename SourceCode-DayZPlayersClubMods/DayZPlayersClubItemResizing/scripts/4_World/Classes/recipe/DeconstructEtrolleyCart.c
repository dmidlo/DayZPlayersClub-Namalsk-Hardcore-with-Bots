class DeconstructEtrolleyCart extends RecipeBase
{	
	override void Init()
	{   
		m_Name = "Take Apart E-Trolley Cart"; //Название-действие
		...
		InsertIngredient(0,"Wrench");      //Вы можете вставить несколько ингредиентов таким образом
		...
		//Ингредиенты #2
		//ИСПОЛЬЗУЕМЫЙ ПРЕДМЕТ
		InsertIngredient(1,"Spur_Trolley_E_Kart");
		...
		//РЕЗУЛЬТАТ 
		AddResult("Spur_WonkyTrolley"); //Добавить результаты здесь
		...
		AddResult("Spur_EKart_Motor"); //Добавить результаты здесь
		...
		AddResult("BatteryCharger"); //Добавить результаты здесь
