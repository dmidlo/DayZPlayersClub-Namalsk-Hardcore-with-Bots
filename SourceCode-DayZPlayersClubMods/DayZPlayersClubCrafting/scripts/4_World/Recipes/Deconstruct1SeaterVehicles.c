class Deconstruct1SeaterVehicles extends RecipeBase
{	
	override void Init()
	{   
		...
		//Ингредиенты #2
		//ИСПОЛЬЗУЕМЫЙ ПРЕДМЕТ
		InsertIngredient(1,"Motoblok");
		InsertIngredient(1, "Motoblok_NT_Green");
		InsertIngredient(1,"TR142");
		InsertIngredient(1, "TR142_Yellow");
