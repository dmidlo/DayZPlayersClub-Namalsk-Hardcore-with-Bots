modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "DayZPlayersClubForgedTerritoriesLoadscreen/data/Loadscreen.edds");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadImageFile(0, "DayZPlayersClubForgedTerritoriesLoadscreen/data/Loadscreen.edds");
		return w;
	}
}
